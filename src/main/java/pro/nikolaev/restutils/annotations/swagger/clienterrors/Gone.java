 ...
 * openApi documentation with predefined HTTP status code 410.
 ...
 *
 * <p><b>NOTE:</b> {@code @Gone} is processed if annotated method
...
@ApiResponse(responseCode = "410", description = "Более не доступно",
