 ...
 * openApi documentation with predefined HTTP status code 423.
 ...
 *
 * <p><b>NOTE:</b> {@code @Locked} is processed if annotated method
...
@ApiResponse(responseCode = "423", description = "Заблокировано",
