 ...
 * openApi documentation with predefined HTTP status code 202.
 ...
 *
 * <p><b>NOTE:</b> {@code @Accepted} is processed if annotated method
...
@ApiResponse(responseCode = "202", description = "Запрос получен", useReturnTypeSchema = true)
@Documented
