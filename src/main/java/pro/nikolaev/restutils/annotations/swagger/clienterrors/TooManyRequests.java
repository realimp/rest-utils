 ...
 * openApi documentation with predefined HTTP status code 429.
 ...
 *
 * <p><b>NOTE:</b> {@code @TooManyRequests} is processed if annotated method
                ...
                examples = @ExampleObject("""
                        {
                          ...
                          "details": "Нельзя добавить более 10 обращений в час"
                        }
                        """),
