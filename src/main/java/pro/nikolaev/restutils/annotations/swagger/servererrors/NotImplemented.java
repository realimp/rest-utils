 ...
 * openApi documentation with predefined HTTP status code 501.
 ...
 *
 * <p><b>NOTE:</b> {@code @NotImplemented} is processed if annotated method
...
@ApiResponse(responseCode = "501", description = "Не реализовано",
